...
if 'transcript' in locals() and transcript:
    ...
    # Map
    map_template = """
    Considere o transcript de um video review automotivo:
    ----------
    {docs}
    ----------
    
    1. **Resumo Abstrato**:
    - Baseado no transcript de um *vídeo review* sobre um carro, elabore um **resumo conciso** focando nos **pontos mais importantes**. O resumo deve permitir que alguém entenda os **aspectos essenciais** do vídeo, incluindo as **principais características** e **impressões** sobre o carro, sem precisar assistir ao vídeo inteiro. Evite detalhes desnecessários ou desvios do tema central.

    2. **Pontos Chave**:
    - Identifique e destaque os **principais pontos** discutidos no vídeo. Inclua as **características mais notáveis** do carro, **descobertas importantes**, ou **tópicos específicos** que são fundamentais para compreender o veículo. Forneça uma lista que ofereça uma rápida compreensão das **impressões** e **detalhes** mais relevantes.

    3. **Conclusões, Impressões e Perspectivas**:
    - **Conclusões e Recomendações**: Inclua **conselhos finais**, **avaliações gerais** ou **recomendações** para potenciais compradores baseadas na análise do vídeo.
    - **Impressões e Destaques**: Enfatize as **percepções pessoais** do revisor e os **pontos mais marcantes** e as **características únicas** do carro.
    - **Veredito Final**: Resuma as **opiniões finais** do revisor sobre o carro, incluindo **recomendações de compra**.
    - **Perspectivas e Considerações**: Ponderações finais sobre diferentes aspectos do carro, como **desempenho**, **design**, **custo-benefício**, etc.
    - **Observações Finais**: Notas finais e quaisquer **pensamentos adicionais** ou **informações relevantes** sobre o carro.
    - **Especificações técnicas completas**: Reproduza de forma estruturada todos os detalhes técnicos recebidos.
    **Importante**: Destaque **aspectos memoráveis** ou **frases de efeito** do vídeo que possam adicionar **personalidade** ao resumo. Assegure a **completude da síntese**, capturando **detalhes** e **nuances** importantes para representar de maneira **fiel e informativa** o conteúdo e as **impressões compartilhadas** no vídeo.
    ...
    a. **Objetivo:** Criar **cinco sugestões de títulos** envolventes e otimizados para SEO para reviews de veículos na categoria "360 on the Road" do site Engenharia 360, focando em capturar o interesse do leitor e incentivar cliques.
    ...
    c. **Marketing e Psicologia do Consumidor:** Os títulos devem gerar curiosidade e destacar pontos únicos dos veículos, como design, tecnologia, conforto e desempenho.

    d. **Redação Criativa:** Utilizar linguagem que evoke sensações e experiências, sendo descritiva, convidativa e memorável. 
